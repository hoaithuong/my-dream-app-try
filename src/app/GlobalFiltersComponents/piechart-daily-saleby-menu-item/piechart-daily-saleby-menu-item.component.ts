...
@Component({
  selector: 'app-piechart-daily-saleby-menu-item',
  template: '<div style="height: 300px" [id]="rootDomID"></div>'
})
export class PiechartDailySalebyMenuItemComponent implements OnInit {

  measures = [
    Model.measure(averageDailyTotalSales).localIdentifier("AverageDailyTotalSales").format("#,##0")
  ]
  viewBy = Model.attribute(menuCategoryAttributeDFIdentifier).localIdentifier("MenuCategory")
  filters = [
