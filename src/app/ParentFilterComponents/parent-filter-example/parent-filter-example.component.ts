...
import {  
  ...
  locationStateAttributeIdentifier} from '../../../fixtures';
  ...
  render() {
    ...
    if (this.stateFilterValues.length) {
      ...
      const afm = {
        ...
        filters: [{
          expression: {
            // value: "({attr.restaurantlocation.locationstate} IN ([/gdc/md/exveshu0intwbr4nk6ao8ft6vesjiqus/obj/2210/elements?id=6340116])) OVER {attr.restaurantlocation.locationid} TO {attr.restaurantlocation.locationcity}",
            value:
