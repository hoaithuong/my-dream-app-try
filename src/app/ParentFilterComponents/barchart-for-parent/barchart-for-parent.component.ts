...
@Component({
  selector: 'app-barchart-for-parent',
  // template: '<div style="height: 300px" [id]="rootDomID"></div>'
  templateUrl: './barchart-for-parent.component.html',
  styleUrls: ['./barchart-for-parent.component.css']
})

export class BarchartForParentComponent implements OnInit {
  filter: any;
  filters: any[];
  measures = [
