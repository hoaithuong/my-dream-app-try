...
import { projectId, locationNameDisplayFormIdentifier, franchisedSalesIdentifier } from '../../fixtures';
...
@Component({
  selector: 'app-measure-value-filters-example',
  templateUrl: './measure-value-filters-example.component.html',
  styleUrls: ['./measure-value-filters-example.component.css']
})

export class MeasureValueFiltersExampleComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit  {
  @Input() filters: any[];
